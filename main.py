...
from utils import check, get_connection, get_status
from constants import (TELEGRAM_TOKEN, FORMAT, 
                       MUON_TEXT, ABOUT_TEXT, 
                       HELP_TEXT, LINKS_NODE_ID,
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            try:
                ...
                tag_div = soup.find(
                    'div', class_='sc-12fa1d5b-0 fQGscc card rounded-4 p-3 position-relative overflow-hidden h-100'
                    )
                uptime_value = next(
